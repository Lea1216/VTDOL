//Heatmap
        ...
        d3.csv("https://raw.githubusercontent.com/Lea1216/MasterThesis/main/heatmap.csv", function(data) {
                  ...
                  //Add descriptions for rows and colums
                      ...
                      // svg2.append("text").attr("x", 200).attr("y", -90).text("Categories").attr("alignment-baseline","middle").attr("class","xaxisdescription")
        ...
        var mousemove_x = function(d,i) {
          tooltip3
            .html("<img src=" + data[i].explanationcard + " class=image>")
        }
        ...
        click_xaxis.on("mouseover", mouseover_x)
...
//Zoomable Circles
      ...
      d3.json("https://raw.githubusercontent.com/Lea1216/MasterThesis/main/zoomableCircles", function(error,root) {
        ...
        var headline = g.selectAll("text")
                    ...
                    // .on("mouseover", function(d){return tooltip3.html("<img class=img src="+d.data.card+">").style("visibility", "visible").style("right","50px").stlye("top","1500px");})
